...
if optimization_method == "Max Sharpe Ratio":
    ...
    # Replace with the relevant code or data for the pie chart
    # (Paste the pie chart code here, for brevity it's excluded)
    st.pyplot(fig1)
    ...
    # (Paste the Minimum Variance bar chart code here)
    st.pyplot(fig2)
